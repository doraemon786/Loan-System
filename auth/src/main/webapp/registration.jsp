    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin">
        ...
        <spring:bind path="username">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="username" class="form-control" placeholder="Full Name" autofocus="true"></form:input>
        ...
        <spring:bind path="email">
          ...
          <spring:bind path="phoneno">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="phoneno" class="form-control" placeholder="phoneno" autofocus="true"></form:input>
